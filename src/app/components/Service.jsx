...
export default async function Service() {
    ...
    return (
        <div className=" mt-40 container mx-auto">
            <div className="flex flex-col items-center text-center lg:w-1/2 mx-auto gap-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 py-10 px-2">
                {
            ...
            <div className="flex justify-center">
                <button className="btn btn-outline text-red-500 rounded-sm hover:bg-red-500 hover:border-red-500">More Services</button>
            </div>
        </div>
    )
}
